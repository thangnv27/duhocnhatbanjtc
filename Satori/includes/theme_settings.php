...
$options = array(
    ...
    array("name" => "Video Giới thiệu",
        "desc" => "Kích thước 220 x 250",
        "id" => $shortname . "_video",
        "std" => '<iframe width="220" height="250" src="//www.youtube.com/embed/ooOsKJmqb-A?rel=0" frameborder="0" allowfullscreen></iframe>',
        "type" => "textarea"),
    array("name" => "Subiz License ID",
        "desc" => "Subiz License ID. Ví dụ: 5545",
        "id" => "ppo_subizID",
        "std" => "5545",
        "type" => "text"),
...
$fields = array(
    "keywords_meta", "description_meta", "favicon", "sitelogo", "footer_col1", "footer_col2", "footer_col3", "bg_header", "bg_banner",
);
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br />
                            <span class="description">Mô tả ngắn gọn về nội dung trang web của bạn.</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th><label for="bg_banner">Ảnh banner trang chủ</label></th>
                        <td>
                            <input type="text" name="bg_banner" id="bg_banner" value="<?php echo stripslashes(get_settings('bg_banner'));?>" class="regular-text" />
                            <input type="button" id="upload_bg_banner_button" class="button button-upload" value="Upload" />
                            <br />
                            <span class="description">Ảnh banner trang chủ. Size tối đa 680x X (x tùy ý)</span>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="footer_col1">Thông tin văn phòng Bắc Giang</label></th>
                        <td>
                            <?php 
                            wp_editor(stripslashes(get_settings('footer_col1')), 'footer_col1', array(
                                'textarea_name' => 'footer_col1',
                            ));
                            ?>
                            <br />
                    ...
                    <tr>
                        <th><label for="footer_col2">Thông tin văn phòng Hà Nội</label></th>
                        <td>
                            <?php 
                            wp_editor(stripslashes(get_settings('footer_col2')), 'footer_col2', array(
                                'textarea_name' => 'footer_col2',
                            ));
                            ?>
                            <br />
                            <span class="description"></span>
                    ...
                    <tr>
                        <th><label for="footer_col3">Thông tin văn phòng Tokyo - Nhật Bản</label></th>
                        <td>
                            <?php 
                            wp_editor(stripslashes(get_settings('footer_col3')), 'footer_col3', array(
                                'textarea_name' => 'footer_col3',
                            ));
                            ?>
                            <br />
                            <span class="description"></span>
